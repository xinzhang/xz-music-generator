...
class MusicGenServer:
    ...
    def generate_prompt(self, description: str):
        # insert description to template
    ...
    def generate_and_upload_to_s3(
        ...
        # AWS Setup user/policy/bucket 
        # Create s3 bucket, lyrics, thumbnails, songs
        # IAM user 
        # - frontend (nextjs) getObject, listObject
        # - backend (modal) putObject, readAccess, listObject
...
def main():
    ...
    # ---- TEST for generate_from_description
    server = MusicGenServer()
    ...
    request_data = GenerateFromDescriptionRequest(
        full_described_song="Acoustic Ballard",
        guidance_scale=15
